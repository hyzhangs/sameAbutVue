...
export default {
  ...
  mounted() {
    // 设置滚动盒子的高度
    const leftpanenls = document.querySelector(".leftpanenls");
    const rightpanenls = document.querySelector(".rightpanenls");
    const bodHeight = document.documentElement.clientHeight;
    leftpanenls.style.height = bodHeight - 57 + "px";
    rightpanenls.style.height = bodHeight - 57 + "px";
  }
};
</script>
